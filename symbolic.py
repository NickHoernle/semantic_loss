...
def get_logic_terms(dataset, lower_lim=-10, device="cuda"):
    if dataset == "cifar10":
        ...
        # ]
        terms = [
            GEQConstant(ixs1=[0, 1, 9, 8], ixs_less_than=[2, 3, 4, 5, 6, 7], ixs_not=[], threshold_upper=0., threshold_lower=lower_lim, device=device),
            GEQConstant(ixs1=[3, 4, 5, 7], ixs_less_than=[0, 1, 2, 6, 8, 9], ixs_not=[], threshold_upper=0., threshold_lower=lower_lim, device=device),
            GEQConstant(ixs1=[2, 6], ixs_less_than=[0, 1, 3, 4, 5, 7, 8, 9], ixs_not=[], threshold_upper=0., threshold_lower=lower_lim, device=device),
        ]
        return terms
