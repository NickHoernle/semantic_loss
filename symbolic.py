...
def get_logic_terms(dataset, lower_lim=-10, device="cuda"):
    if dataset == "cifar10":
        ...
        terms = [
            ...
            GEQConstant(ixs1=[2], ixs_neg=[0, 1, 3, 4, 5, 6, 7, 8, 9], ixs_not=[], threshold_upper=0., threshold_lower=-20),
            GEQConstant(ixs1=[6], ixs_neg=[0, 1, 2, 3, 4, 5, 7, 8, 9], ixs_not=[], threshold_upper=0., threshold_lower=-20),
        ]
        return terms
