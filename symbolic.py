...
def get_logic_terms(dataset, lower_lim=-10, device="cuda"):
    if dataset == "cifar10":
        ...
        # ]
        terms = [
            GEQConstant(ixs1=[0, 1, 8, 9], ixs_less_than=[2, 3, 4, 5, 6, 7], ixs_not=[], threshold_upper=-2., threshold_lower=lower_lim, device=device),
            GEQConstant(ixs1=[2, 3, 4, 5, 6, 7], ixs_less_than=[0, 1, 8, 9], ixs_not=[], threshold_upper=-2., threshold_lower=lower_lim, device=device),
