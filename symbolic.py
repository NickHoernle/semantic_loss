...
def get_logic_terms(dataset, lower_lim=-10, device="cuda"):
    if dataset == "cifar10":
        ...
        # ]
        terms = [
            GEQ_Interaction(ixs1=[0, 8], ixs_less_than=[1, 2, 3, 4, 5, 6, 7, 9], weights=[1., 1.], intercept=0., threshold_lower=-1, device=device),
            GEQ_Interaction(ixs1=[1, 9], ixs_less_than=[0, 2, 3, 4, 5, 6, 7, 8], weights=[1., 1.], intercept=0., threshold_lower=-1, device=device),
            GEQ_Interaction(ixs1=[3, 4, 5, 7], ixs_less_than=[0, 1, 2, 6, 8, 9], weights=[1., 1., 1., 1.], intercept=0., threshold_lower=-1, device=device),
